    ...
    public static void main(String[] args) {
        ...
        try {
            calledNumbers = parseInput(
                "/home/miya/code/aoc/2021/04/part2/src/lgbt/miya/input.txt", boards);
